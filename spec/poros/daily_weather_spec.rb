...
RSpec.describe DailyWeather do
  it 'exists' do
    ...
    expect(daily_weather.date).to eq('2020-11-8')
    ...
    expect(daily_weather.max_temp).to eq('287.58 degrees Fahrenheit')
    expect(daily_weather.min_temp).to eq('282.59 degrees Fahrenheit')
